...
PROCESSING_STEPS: tuple[ProcessingStepSpec, ...] = (
    ...
    ProcessingStepSpec(
        ...
        "基于已解压数据生成 SLC 数据。",
        ("task_root", "satellite", "polarization", "swath"),
    ),
    ProcessingStepSpec(
        "extract_burst",
        "提取 Burst",
        ...
        ("task_root", "polarization", "swath", "bn_start1", "bn_end1"),
    ),
    ProcessingStepSpec(
        "slc_geo",
        "主影像地理编码",
        "run_slc_geo_real",
        "为主影像生成地理编码相关结果。",
        ("task_root", "dem_file", "master_date"),
    ),
    ProcessingStepSpec(
        "coregistration",
        "主从影像配准",
    ...
    ProcessingStepSpec(
        ...
        "按人工确认的范围裁剪 RSLC。",
        ("task_root", "master_date", "polarization", "swath"),
    ),
    ProcessingStepSpec(
        "write_rslc_tab",
        "生成 RSLC_tab",
    ...
    ProcessingStepSpec(
        ...
        "按选择的差分方法生成差分干涉图。",
        ("task_root", "dem_file", "master_date", "diff_method"),
    ),
    ProcessingStepSpec(
        "select_shp",
        "SHP 同质像元选取",
        ...
        "调用 MATLAB 方法选择同质像元。",
        ("task_root", "master_date", "matlab_func_dir", "shp_method"),
    ),
    ProcessingStepSpec(
        "phase_optimization",
        "相位优化",
        ...
        "调用相位优化方法生成优化结果。",
        ("task_root", "matlab_func_dir", "phase_opt_method", "shp_method"),
    ),
    ProcessingStepSpec(
        "file_construct",
        "组织 StaMPS 时序文件",
    ...
    ProcessingStepSpec(
        ...
        ("task_root", "master_date", "point_selection_method"),
    ),
    ProcessingStepSpec(
        "stamps_processing",
        "StaMPS 处理",
